...
struct PageViewController: UIViewControllerRepresentable {
    ...
    var viewControllers: [UIViewController]
     ...
     func makeCoordinator() -> CoordinatorPageView {
        CoordinatorPageView(self)
    }
...
class CoordinatorPageView: NSObject, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
